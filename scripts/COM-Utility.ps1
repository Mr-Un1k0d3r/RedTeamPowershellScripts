function Invoke-COM-ShellApplication {
	...
	BEGIN {
		...
		Write-Output "[+] Executing ShellApplication COM object on $($ComputerName)"
	}
	
	PROCESS {
		$Instance = [activator]::CreateInstance([type]::GetTypeFromCLSID($GUID, $ComputerName))
...
function Invoke-COM-ProcessChain {
	...
	BEGIN {
		...
		Write-Output "[+] Executing ProcessChain COM object on $($ComputerName)"
	}
...
function Invoke-COM-WindowsScriptHost {
	...
	BEGIN {
		...
		Write-Output "[+] Executing WindowsScriptHost COM object on $($ComputerName)"
	}
...
function Invoke-COM-ShellBrowserWindow {
	...
	BEGIN {
		...
		Write-Output "[+] Executing ShellBrowserWindow COM object on $($ComputerName)"
	}
...
function Invoke-COM-XMLHTTP {
	...
	BEGIN {
		...
		Write-Output "[+] Executing XML HTTP COM object on $($ComputerName)"
	}
...
function Invoke-COM-ScheduleService {
	...
	BEGIN {
		...
		Write-Output "[+] Executing ScheduleService COM object on $($ComputerName)"
